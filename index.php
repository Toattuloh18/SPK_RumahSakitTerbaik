...
<body>
    ...
    <p class="text-light text-center mb-4">Halo, <strong><?= htmlspecialchars($_SESSION['nama']) ?></strong></p>
    <?php endif; ?>
    ...
    <main class="card-container" role="navigation" aria-label="Menu utama sistem pendukung keputusan">
        ...
        <a href="logout.php" class="card-menu" title="Logout" tabindex="0" role="link" aria-label="Keluar dari sistem">
